...
class UserProfile(models.Model):
    ...
    # team = models.CharField(max_length=20,verbose_name=u'所属部门团队')
    team = models.IntegerField(choices=team_choices,verbose_name=u'所属部门团队')
    user = models.OneToOneField(User)
    class Meta:
        db_table='userprofile'
        verbose_name=u'user扩展表'
...
class collect_config(models.Model):
    pass