...
if __name__ == "__main__":
    ...
    from siteconfig import ormsetting

    dbip = ormsetting.ormsite_parms['mysql_conn']['host']
    dbport = ormsetting.ormsite_parms['mysql_conn']['port']
    dbuser = ormsetting.ormsite_parms['mysql_conn']['user']
    dbpwd = ormsetting.ormsite_parms['mysql_conn']['pwd']
    dbname = ormsetting.ormsite_parms['mysql_conn']['dbname']

    thrdnum = ormsetting.ormsite_parms['schd']['frequency']
    frequency = ormsetting.ormsite_parms['schd']['thrdnum']

    # cf=ConfigParser.ConfigParser()
    # cf.read('../../siteconfig/ormconfig.ini')
